 ...
 * `--------------------+------+------+------|   |------+------+------+--------------------'
 *                      | GUI  |Layer1|Space |   |Space |Layer2|  GUI |
 *                      `--------------------'   `--------------------'
 */
 ...
 */
  ...
  //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
     KC_LSFT, KC_MINS,  KC_EQL, _______, _______, _______,     _______, KC_LCBR, KC_RBRC, KC_DOT,  KC_PLUS,  KC_GRV,
  //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
                                KC_LGUI, _______,  KC_SPC,      MO(3),   KC_LBRC, KC_RBRC
                             //`--------------------------'   `--------------------------'
  ),
 ...
 * |------+------+------+------+------+------|   |------+------+------+------+------+------|
 * |      |  F6  |  F7  |  F8  |  F9  |  F10 |   |  F11 |  F12 | Home | PgDn | PgUp | End  |
 * `--------------------+------+------+------|   |------+------+------+--------------------'
 *                      | Ctrl |  Alt |Layer3|   |      |      |      |
 *                      `--------------------'   `--------------------'
 */
  ...
  //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
      _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,     KC_F11,   KC_F12, KC_HOME, KC_PGDN, KC_PGUP,  KC_END,
  //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
                                 KC_LCTL, KC_LALT, MO(3),      _______, _______, _______
                             //`--------------------------'  `--------------------------'
  ),
