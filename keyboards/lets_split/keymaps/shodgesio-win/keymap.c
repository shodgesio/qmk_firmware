 ...
 * |------+------+------+------+------+------+   +------+------+------+------+------+------|
 * |Adjust| GUI | Alt  | Ctrl  |Lower |Space |   |Space |Raise |  Ctrl | GUI | Pl/Ps| Next |
 * `------------------------------------------   ------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12 ( \
  ...
  ADJUST,   KC_LGUI,  KC_LALT,  KC_LCTL,  LOWER,   KC_SPC,  KC_SPC,  RAISE,  KC_RCTL,  KC_RGUI,  KC_MPLY,  KC_MNXT   \
),
