 ...
 * |------+------+------+------+------+------+   +------+------+------+------+------+------|
 * |Adjust| GUI | Alt  | Ctrl  |Lower |Space |   |Space |Raise |  Ctrl | Alt | Pl/Ps| Next |
 * `------------------------------------------   ------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12 ( \
  ...
  ADJUST,   KC_LGUI,  KC_LALT,  KC_LCTL,  LOWER,   KC_SPC,  KC_SPC,  RAISE,  KC_RCTL,  KC_RALT,  KC_MPLY,  KC_MNXT   \
),
...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______,   _______,  _______,  KC_LCTL,  _______,  _______,  _______,  KC_LBRC,  KC_RBRC,  KC_DOT,   KC_ENT,   _______   \
),
